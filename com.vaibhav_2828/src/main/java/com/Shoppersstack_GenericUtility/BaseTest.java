...
public class BaseTest {
	...
	public void beforeTest() {
		...
		ExtentSparkReporter spark = new ExtentSparkReporter(FrameWorkConstants.reportPath + javautil.localDateTime() + ".html");
